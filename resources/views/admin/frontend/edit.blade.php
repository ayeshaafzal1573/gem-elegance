...
@section('content')
  ...
  <div class="app-content">
    ...
    <div class="app-content-header">
      <h1 class="app-content-headerText">Update Home</h1>
   ...
   <form action="{{ route('home.update',['id' => $banners->id]) }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            ...
            @enderror
          <img id="image-preview" src="{{ asset($banners->image_path) }}" alt="Preview" style="width:100%; height:400px">
 </div>
    </div>
